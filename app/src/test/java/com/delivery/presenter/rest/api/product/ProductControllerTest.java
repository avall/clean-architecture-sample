...
public class ProductControllerTest extends BaseControllerTest {
    ...
    @ComponentScan(basePackages = {
        ...
        "com.delivery.presenter.rest.api.product",
    ...
    public void getProductByIdentityReturnsNotFound() throws Exception {
        ...
        GetProductUseCase.InputValues input = GetProductUseCase.InputValues.builder().id(id).build();
    ...
    public void getByMatchingNameReturnsProducts() throws Exception {
        ...
        SearchProductsByNameOrDescriptionUseCase.InputValues input =
                SearchProductsByNameOrDescriptionUseCase.InputValues.builder().searchText("abc").build();
        SearchProductsByNameOrDescriptionUseCase.OutputValues output =
            SearchProductsByNameOrDescriptionUseCase.OutputValues.builder().products(singletonList(product)).build();
    ...
    public void getAllProductsReturnsProducts() throws Exception {
        ...
        GetAllProductsUseCase.InputValues input = GetAllProductsUseCase.InputValues.builder()
            .build();
        GetAllProductsUseCase.OutputValues output =
                GetAllProductsUseCase.OutputValues.builder().products(singletonList(product)).build();
    ...
    public void getProductByIdentityReturnsOk() throws Exception {
        ...
        Product product = TestCoreEntityGenerator.randomProduct();
        Store store = product.getStore();
        GetProductUseCase.InputValues input = GetProductUseCase.InputValues.builder().id(product.getId()).build();
        GetProductUseCase.OutputValues output = GetProductUseCase.OutputValues.builder().product(product).build();
