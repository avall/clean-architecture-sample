...
public class StoreControllerTest extends BaseControllerTest {
    ...
    @ComponentScan(basePackages = {
        ...
        "com.delivery.presenter.rest.api.store",
    ...
    public void getAllStoresReturnsOk() throws Exception {
        ...
        GetAllStoresUseCase.OutputValues output = GetAllStoresUseCase.OutputValues.builder().stores(singletonList(store)).build();
    ...
    public void getStoreByIdentityReturnsOk() throws Exception {
        // given
        Store store = TestCoreEntityGenerator.randomStore();
        GetStoreUseCase.OutputValues output = GetStoreUseCase.OutputValues.builder().store(store).build();
    ...
    public void getAllStoresNameMatchingReturnsStores() throws Exception {
        //given
        Store store = TestCoreEntityGenerator.randomStore();
        SearchStoresByNameUseCase.InputValues input = SearchStoresByNameUseCase.InputValues.builder().searchText("abc").build();
        SearchStoresByNameUseCase.OutputValues output =
                SearchStoresByNameUseCase.OutputValues.builder().stores(singletonList(store)).build();
    ...
    public void getProductsByStoreIdReturnsStoreProducts() throws Exception {
        ...
        GetProductsByStoreUseCase.InputValues input = GetProductsByStoreUseCase.InputValues.builder().id(id).build();
        GetProductsByStoreUseCase.OutputValues output = GetProductsByStoreUseCase.OutputValues.builder().products(singletonList(product)).build();
